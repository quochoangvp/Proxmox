...
#Install TightVNC
open_admin_ps
send_line_to_vm "Invoke-WebRequest -Uri https://raw.githubusercontent.com/quochoangvp/Proxmox/remz/misc/powershell/Install-TightVNC.ps1 -OutFile Install-TightVNC.ps1"
sleep 5
...
send_line_to_vm "Invoke-WebRequest -Uri https://raw.githubusercontent.com/quochoangvp/Proxmox/remz/misc/powershell/Install-Nvidia.ps1 -OutFile Install-Nvidia.ps1"
sleep 5
#send_line_to_vm "set-executionpolicy remotesigned -Scope Process -Force"
#send_line_to_vm "set-executionpolicy -Scope Process -Force -ExecutionPolicy Bypass"
#sleep 2
